...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/duet-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14379&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/duet-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `duet-python` can be installed with:

```
conda install duet-python
```

It is possible to list all of the versions of `duet-python` available on your platform with:
